					...
					<div style="float: left;">
						<select name="job_company" id="job_company" style="width: 260px; margin-right: 10px;">
							<?php 
								...
								$wp_query->query('post_type=company&posts_per_page=-1&post_status=publish&author='.$td_user_id);
							...
							?>
							<option value='<?php echo $id; ?>' <?php selected( $td_job_company, $id ); ?>><?php echo $wpjobus_company_fullname; ?></option>
							<?php endwhile; ?>
						</select>
					</div>
