...
get_header(); ?>
	...
	<?php 
		...
		if (isset($_GET['job_location'])) {
		    $td_job_location_search = $_GET['job_location'];
		} else {
		    $td_job_location_search = "";
		}

		if($td_job_location_search == "all") {
			$td_job_location_search = "";
		}
		...
		if(!empty($td_job_location_search)) {

			$stringLocation = "AND m2.meta_key = 'job_location' AND m2.meta_value = '" . $td_job_location_search . "'";
						...
						<div class="filters">
							...
							<div class="full sidebar-widget-bottom-line">
								...
								<div class="full">
									...
									<div class="one_half" style="margin-bottom: 0;">
										...
										<span class="filters-subtitle"><?php _e( 'Presence', 'themesdojo' ); ?></span>
							...
							<div class="full sidebar-widget-bottom-line">
								...
								<?php
        							...
        							$min = $max = $medium = 0;
									$min = isset($wpjobus_companies_est_year[$s] -> meta_value)?$wpjobus_companies_est_year[$s] -> meta_value:0;
									$max = isset($wpjobus_companies_est_year[count($wpjobus_companies_est_year)-1] -> meta_value)?$wpjobus_companies_est_year[count($wpjobus_companies_est_year)-1] -> meta_value:1;
							...
							<div class="full sidebar-widget-bottom-line">
								...
								<span class="filters-subtitle"><?php _e( 'Salary', 'themesdojo' ); ?></span>
							...
							<div class="full sidebar-widget-bottom-line">
								...
								<div class="one_half">
									...
									<ul class="filters-lists-location">
										...
										<li class="filters-list-location-all <?php if(empty($td_job_location_search)) { ?>active<?php }?>">
											<i class="fa fa-square-o"></i><i class="fa fa-check-square"></i><?php _e( 'All Locations', 'themesdojo' ); ?>
											<input type="hidden" class="company-location-all" name="company_location_all" value="<?php if(empty($td_job_location_search)) { ?>1<?php } ?>" />
										</li>
										...
										<li class="filters-list-location <?php if($td_job_location_search == $redux_demo['resume-locations'][$i] ) { ?>active<?php } ?>">
											...
											<input type="hidden" class="company-location" name="company_location[<?php echo $i; ?>]" value="<?php if($td_job_location_search == $redux_demo['resume-locations'][$i] ) { echo $redux_demo['resume-locations'][$i]; } ?>" />
										</li>
