		...
		<div class="container">
			...
			<div class="resume-skills">
				...
				<form id="wpjobus-add-resume" type="post" action="" >
					...
					<h1 class="resume-section-title"><i class="fa fa-file-text-o"></i><?php _e( 'Add Your Resume', 'themesdojo' ); ?></h1>
							...
							<span class="full" style="margin-bottom: 0;">
								...
								<span class="three_fifth" style="margin-bottom: 0;">
									<select name="resume_gender" id="resume_gender" style="width: 100%;">
										<option value="Male" <?php global $td_resume_gender; selected( $td_resume_gender, 'Male' ); ?>>Male</option>
								...
								<span class="three_fifth" style="margin-bottom: 0;">
									...
									<select name="resume_day_birth" id="resume_day_birth" style="width: 26%; width: -webkit-calc(30% - 10px); width: calc(30% - 10px); margin-right: 10px;">
										<?php 
											for ($i = 1; $i <= 31; $i++) {
										?>
										<option value='<?php echo $i; ?>' <?php global $td_resume_day_birth; selected( $td_resume_day_birth, $i ); ?>><?php echo $i; ?></option>
										<?php 
											}
										?>
									</select>
									...
									<select name="resume_year_birth" id="resume_year_birth" style="width: 40%;">
										...
										?>
										<option value='<?php echo $i; ?>' <?php global $td_resume_year_birth; selected( $td_resume_year_birth, $i ); ?>><?php echo $i; ?></option>
										<?php 
											}
										?>
									</select>
								...
								<span class="three_fifth" style="margin-bottom: 0;">
									<select name="resume_years_of_exp" id="resume_years_of_exp" style="width: 100%;">
										<?php 
											for ($i = 1; $i <= 20; $i++) {
										?>
										<option value='<?php echo $i; ?>' <?php global $td_resume_years_of_exp; selected( $td_resume_years_of_exp, $i ); ?>><?php echo $i; ?></option>
										<?php 
											}
										?>
									</select>
							...
							<span class="full" >
								...
								<span class="three_fifth" style="margin-bottom: 0;">
									<select name="resume_career_level" id="resume_career_level" style="width: 100%; margin-right: 10px;">
										<?php 
											global $redux_demo, $td_resume_career_level; 
					...
					<div class="full save-resume-block">
						...
						<div class="full" style="margin-bottom: 0;">
							...
							<div id="success">
								<span>
									<h3><?php _e( 'Resume Saved Successful.', 'themesdojo' ); ?></h3>
								</span>
								<div class="divider"></div>
							</div>
						...
						<?php
							...
							$comp_valid = $redux_demo['resume-featured-validity']; 
							$comp_price = $redux_demo['resume-featured-price'];  
						...
						<div class="full">
							...
							<h3 class="resume-section-subtitle" style="margin-bottom: 0;"><?php if(!empty($dec)) { ?><?php _e( 'Regular resume costs:', 'themesdojo' ); ?> <?php echo $dec; echo $price_symbol; echo "."; ?><?php } ?> <?php if(!empty($dec_feat)) { ?><?php _e( 'Featured resume costs:', 'themesdojo' ); ?> <?php echo $dec_feat; echo $price_symbol; ?>/<?php echo $comp_valid; ?> <?php _e( 'Days', 'themesdojo' ); ?><?php } ?></h3>
						...
						<span class="submit-resume-button">
							...
							<input style="margin-bottom: 0;" name="submit" type="submit" value="<?php if($recipe_state == "1" or current_user_can('administrator')) { _e( 'Submit Resume', 'themesdojo' ); } else { _e( 'Submit Resume For Review', 'themesdojo' ) ;} ?>" class="input-submit">	 
